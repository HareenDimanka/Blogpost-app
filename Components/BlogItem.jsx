...
const BlogItem = ({ title, description, category, image, id, viewCount }) => {
    return (
        <div className='max-w-[330px] sm:max-w-[300px] bg-white border border-black hover:shadow-[-3px_3px_0px_#000000]'>
            <Link href={`/blogs/${id}`}>
